...
Satu pesan, dua sub-agent dengan kemampuan eksplorasi read-only; gunakan role/tipe read-only yang tersedia (misalnya `explore` bila runtime menyediakannya), tanpa saling lihat konteks:
